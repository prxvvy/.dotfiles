...
#if BAR_PANGO_PATCH
static const char font[]                 = "MesloLGL Nerd Font 10";
#else
static const char *fonts[]               = { "Hack Nerd Font:size=11:weight=bold:antialias=true:autohint:true", "MesloLGL Nerd Font:size=11:weight=bold:antialias=true:autohint:true" };
...
static const char *rofimenu[] = { "rofi", "-show", "drun", "-show-icons", "-theme", "gruvbox-dark-hard", "-font", "MesloLGL Nerd Font 12", NULL };


static const char *roficmd[] = { "rofi", "-show", "run", "-show-icons", "-theme", "gruvbox-dark-hard", "-font", "MesloLGL Nerd Font 12",  NULL };
